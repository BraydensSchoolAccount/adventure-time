    ...
    def command_check(command):
        ...
        match command:
            ...
            case "exit":
                ...
                confirmation = get_input(False,True,"Yes!","WAIT, No!")
                if confirmation == 1:
                    print("Okay, bye!")
                    return 1
            case "help" | "?":
...
Then backwards... Then left, right, down, up, down again, forward, and through the wall. Somehow the head trauma didn't kill you. Yet. You're in the broom closet.""")
    ...
    match input_value:
        case 1:
            ...
            pause()
            os.system("cls")
            print("You suddenly feel cold metal on the back of your head. The museum is guarded")
            fail("YAYYY! WOO! YOU DID IT! YIPEEEE!")
        case 2:
            print("You jump up into the vent above your head and start crawling through the ac system. You see an exhibit through another vent so you drop down")
            pause()
            print("It's not the one with the bracelet! You look over and see a sign pointing to the bracelet exhibit, but there's a locked door in the way. You're in some sort of artifact room")
            input_value = get_input(False, True, "Liquidifier","Backwards long jump", "Mummies Hair","Godly Hammer","Telekinesis")
            match input_value:
                case 1:
                    print("You use the Liquidifier and slide the slider all the way to the right, successfully turning into water! The guards in the next room try to shoot at you but it does nothing.")
                    pause()
                    print("...wait, how do you work the slider?")
                    fail("You just HAD to go all in!")
                case 2:
                    print("After a good kick backwards and a few wahoos, you clip through the door! But your velocity is too great and you proceed to hit your skull on even more walls, killing you.")
                    fail("Did you leave the plot armor with the jetpack?")
                case 3:
                    pass
                case 4:
                    print("""You read the label of the exhibit. It read something like "tor hammer".
You proceed to lift it with all your might, it starts to move! You finally get it off the stand over your feet and- *comedic slip sound*""")
                    ...
                    fail("Only the worthy shall lift the hammer... and you're stealing a bracelet")
                case 5:
                    print("You point your hands to your head and hunch over to try to use your telekinesis")
                    pause()
                    print("A guard walks by and sees you")
                    fail("You look like a moron")
            print("This doesn't exactly seem too helpful. You try putting it in the lock, hoping it will somehow do something.")
            pause()
            print("Somehow, click! The lock falls off the door. That's... not how locks work but oh well. You walk into the exhibit with the bracelet, there are 2 guards talking. They haven't noticed you yet")
            input_value = get_input(False, True, "KILLSTREAK","Unplug Router", "Boombox")
            match input_value:
                case 1:
                    print("You forgot what killstreaks you equipped, but they must be good. Is it a predator missile? A droke strike? A nuke?")
                    pause()
                    os.system("cls")
                    print('"Friendly UAV active"')
                    pause()
                    print("The guards, seeing the message, turn around to see you crouching on the floor like a gremlin")
                    fail("Knowledge is power!")
                case 2:
                    print("After unplugging the router, you walk right through the guards getting to the case. You plug the router back in and wait the 30 seconds required for the internet to kick back on.")
                    pause()
                    os.system("cls")
            ...
            pause()
            print("""The guards are so "annoyed" that they go to "investigate" that while "breaking some boxes up".
Despite how much you want to see the obvious dance battle happening, you came here for the bracelet. There's a thick glass casing between you and the bracelet""")
            input_value = get_input(False, True, "Smash glass using hammer","Use laser")
            match input_value:
                case 1:
                    print("Wha-What? WHY WOULD YOU DO THAT! Glass is loud you idiot, who told you \"hammer\" was the right option? I don't even think I need to tell you what happened.")
                    fail("What logic lead you to that conclusion?")
                case 2:
                    pass
            print("The laser cuts cleanly through the glass. After you remove the glass carefully, you grab the bracelet and retrace your steps. With no problems, you leave the way you came")
            ending("Venting Ninja")
        case 3:
            print("You get in the surprisingly dry mop bucket, equip the mop like a jousting lance, and put a bucket on your head for protection. You open the door and ride into battle")
            pause()
            print("You are confronted by two guards in a doorway")
            input_value = get_input(False, True, "Green Shell","Drift", "Nitro Boost")
            match input_value:
                case 1:
                    print("You throw the green shell with all your might and hit a guard! Good job! Wait, 1... 2- oh no there were 2 guards. The other one opens fire")
                    fail("You should've had the bullet bill")
                case 2:
                    print("You do a sick drift, going right into a guard, knocking them over! Unfortunately, you didn't see the wall behind them before you crashed into it.")
                    fail("I'm surprised that has traction")
                case 3:
                    pass
            print("Just like real life, you decide to avoid your problems. Turning on the boosters, you go right past the guards, who proceed to miss all their shots. You're right next to the bracelet, what's your next move?")
            input_value = get_input(False, True, "Think","Throw the glass", "Smash the glass using fist", "Smash the glass hammer")
            match input_value:
                case 1:
                ...
                case 2:
                    pass
                case 3:
                    print("ou hype yourself up to punch the glass. Breathe in, Breathe out, throw some shadow punches, get ready...")
                    pause()
                    print("While being your own hype-man, you get shot")
                    fail("Don't worry, you weren't getting through that glass anyways")
                case 4:
                    print("You smash the glass hammer nearby. What did this accomplish?")
                    fail("Can you even read?")
            print("It's heavy, but it was pretty easy to throw off. You grab the bracelet and put it on. Now you might wanna get out before those guards catch up")
            input_value = get_input(False, True, "Think","Throw the glass", "Smash the glass using fist", "Smash the glass hammer")
            match input_value:
                case 1:
                    print("You grab the cheat gun off the table and type \">noclip >fly\" into the console, and get out of there. But cheats aren't allowed on this server, so I'm banning you")
                    pause()
                    os.system("cls")
                ...
                case 2:
                    pass
                case 3:
                    print("You break the dino egg with your bare hands. It's a few million years old though, any dino that would be in there is long dead. It stinks up the whole room causing all the guards to pass out. You aren't immune to the stench")
                    fail("ALRIGHT! I'm back with the drin- what the heck happened")
            print("""Your only real option, let's be honest. You charge into the wall, blowing it down using the mop as you ride out at high speeds.
